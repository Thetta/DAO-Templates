...
contract DaicoFactory {
	...
	function createDaico(_investors) {
		StdDaoToken daicoToken = new StdDaoToken("DevZenToken", "DZT", 18, true, true, 10**25);
		...
		// daoBase.allowActionByVoting(daico.UPDATE_DAO_PARAMS(), daico.daicoToken());
	...
	function setupAutoMethods() internal {
		...
		// daoBase.allowActionByAddress(daico.UPDATE_DAO_PARAMS(), daicoAuto);
		...
		daicoAuto.setVotingParams(daico.UPDATE_DAO_PARAMS(), VOTING_TYPE_1P1V, bytes32(0), UtilsLib.stringToBytes32("DevZenTeam"), bytes32(70), bytes32(70), bytes32(24*7));
